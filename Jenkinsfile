...
// }
        ...
        stage('git checkout') {
            steps {
                // Get some code from a GitHub repository
                 git branch: 'main', url: 'https://github.com/RaphDevOps/jjtech-maven-sonarqube-nexus-project.git'
            }
    ...
    //     }
        ...
        stage('Upload artifact to Nexus') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'nexus-token', passwordVariable: 'PASSWORD', usernameVariable: 'USER_NAME')]) {
